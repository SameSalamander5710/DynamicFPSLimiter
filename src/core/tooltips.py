...
def get_tooltips():
    ...
    "delaybeforedecrease": "Specifies how many times in a row GPU or CPU usage must exceed the upper threshold before the FPS cap begins to drop.",
    ...
    "delaybeforeincrease": "Specifies how many times in a row GPU and CPU usage must fall below the lower threshold before the FPS cap begins to rise.",
